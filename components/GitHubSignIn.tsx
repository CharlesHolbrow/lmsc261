...
export function GitHubSignInButton({ redirectTo }: { redirectTo?: string }) {
  return (
    ...
    >
      <button
        type="submit"
        className="inline-flex cursor-pointer items-center gap-2 rounded bg-gray-900 px-4 py-2 font-medium text-white hover:bg-gray-700"
      >
        <GitHubIcon />
        Sign in with GitHub
      </button>
...
export async function GitHubSignIn({ redirectTo }: { redirectTo?: string }) {
